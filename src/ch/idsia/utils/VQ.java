...
public class VQ {
     ...
     *
     * @param estados        Lista de estados en formato numérico.
     * @param acciones       Lista de acciones en formato numérico.
     * @param numeroEstados  Número de estados del cuantificador vectorial de los estados.
     * @param numeroAcciones Número de acciones del cuantificador vectorial.
     */
     ...
     *
     * @param estado Estado que se quiere cuantificar.
     ...
     *
     * @param accion Accion que se quiere cuantificar.
     ...
     *
     * @param x Primero de los vectores.
     * @param y Segundo de los vectores.
