...
public class QLearning {
     ...
     *
     * @param valorInicial Valor de inicizalización de la tabla q.
     * @param alpha        Valor del parametro alpha.
     * @param gamma        Valor del parametro gamma.
     * @param estados      Dimension de los estados del cuantificador vectorial.
     * @param acciones     Dimension de las acciones del cuantificador vectorial.
     */
     ...
     * @param alpha             Valor del parametro alpha.
     * @param gamma             Valor del parametro gamma.
     * @param numeroEstados     Numero de estados del cuantificador vectorial de los estados.
     * @param dimensionEstados  Dimension de los estados del cuantificador vectorial.
     * @param numeroAcciones    Numero de acciones del cuantificador vectorial.
     * @param dimensionAcciones Dimension de las acciones del cuantificador vectorial.
     */
     ...
     *
     * @param valorInicial Valor al que se inicializan los valores de la tabla Q.
     */
     ...
     *
     * @param estado   Estado donde se encuentra el agente.
     * @param accion   Accion que ejecuta el agente.
     * @param estado   Estado al que transita el agente al aplicar la acción.
     * @param refuerzo Refuerzo obtenido por el agente al ejecutar la accion en el estado dado.
     */
     ...
     * Realiza una actualizacion de la tabla Q en funcion del estado, la accion y el refuerzo obtenidos.
     *
     * @param tupla Tupla con la información de la transición.
     */
     ...
     *
     * @param estado Estado para el cual se quiere calcular el maximo de la funcion Q.
     ...
     *
     * @param estado Estado para el cual se quiere obtener la mejor accion posible.
     ...
     *
     * @param estado Estado para el cual se quiere obtener la accion a ejecutar.
     * @return double[] acciones
     */
    public double[] obtenerAccionEGreedy(double[] estado) {
        ...
        double dado = BaseConocimiento.random.nextDouble();

        if (dado < greedy)
            // Accion aleatoria
            return this._cuatificador.getAcciones((int) (BaseConocimiento.random.nextDouble() * this._cuatificador.getNumeroAcciones()));
        else
            // Mejor accion
     ...
     *
     * @param incremento Incremento que se realiza en el valor de epsilon
     */
